...
##### === Comparison of IC cforest with different mtry's and mtry tuned, and
#####                   IC cforest with different values of minsplit, minprob, minbucket ==== ######
##### N = 200, no right-censoring, censoring interval width generated from G1
L2.Bat.m1.c1.tt1 <- Pred_funct(Nn = 200, distribution = "Bat", model = 1, C.rate = 0, tt = 1, M = 5)
L2.Bat.m2.c1.tt1 <- Pred_funct(Nn = 200, distribution = "Bat", model = 2, C.rate = 0, tt = 1, M = 500)
L2.Bat.m3.c1.tt1 <- Pred_funct(Nn = 200, distribution = "Bat", model = 3, C.rate = 0, tt = 1, M = 500)
L2.Exp.m1.c1.tt1 <- Pred_funct(Nn = 200, distribution = "Exp", model = 1, C.rate = 0, tt = 1, M = 500)
L2.Exp.m2.c1.tt1 <- Pred_funct(Nn = 200, distribution = "Exp", model = 2, C.rate = 0, tt = 1, M = 500)
L2.Exp.m3.c1.tt1 <- Pred_funct(Nn = 200, distribution = "Exp", model = 3, C.rate = 0, tt = 1, M = 500)
L2.lgn.m1.c1.tt1 <- Pred_funct(Nn = 200, distribution = "Lgn", model = 1, C.rate = 0, tt = 1, M = 500)
L2.Lgn.m2.c1.tt1 <- Pred_funct(Nn = 200, distribution = "Lgn", model = 2, C.rate = 0, tt = 1, M = 500)
L2.Lgn.m3.c1.tt1 <- Pred_funct(Nn = 200, distribution = "Lgn", model = 3, C.rate = 0, tt = 1, M = 500)
L2.WD.m1.c1.tt1 <- Pred_funct(Nn = 200, distribution = "WD", model = 1, C.rate = 0, tt = 1, M = 500)
L2.WD.m2.c1.tt1 <- Pred_funct(Nn = 200, distribution = "WD", model = 2, C.rate = 0, tt = 1, M = 500)
L2.WD.m3.c1.tt1 <- Pred_funct(Nn = 200, distribution = "WD", model = 3, C.rate = 0, tt = 1, M = 500)
L2.WI.m1.c1.tt1 <- Pred_funct(Nn = 200, distribution = "WI", model = 1, C.rate = 0, tt = 1, M = 500)
L2.WI.m2.c1.tt1 <- Pred_funct(Nn = 200, distribution = "WI", model = 2, C.rate = 0, tt = 1, M = 500)
L2.WI.m3.c1.tt1 <- Pred_funct(Nn = 200, distribution = "WI", model = 3, C.rate = 0, tt = 1, M = 500)
